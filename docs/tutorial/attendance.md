...
程序会根据“设置”中的校园网访问策略，自动选择直接连接或 WebVPN。通常保持默认的“自动选择”即可；如果你的网络环境比较特殊，也可以在设置中固定为 WebVPN 或直接连接。
...
简单来说：**不在校园网时，程序会通过 WebVPN 访问校内系统**。
:::

## 查询考勤流水

点击 `立刻刷新` 按钮，即可登录并获取最新的考勤流水。你可以查看每条记录的课程名称、打卡时间、打卡状态等详细信息。
